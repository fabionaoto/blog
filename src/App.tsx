...
const App: React.FC = () => {
  ...
  return (
    <div>
      ...
      <h1>Mastering React Hooks: A Deep Dive into useEffect</h1>
      ...
      <h2>Setting Up Your First useEffect</h2>
      ...
      <p>To get started, you need to import useEffect from React:</p>
      ...
      <h2>Implementing Side Effects</h2>
